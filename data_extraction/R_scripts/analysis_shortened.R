...
plot <- function(var, fileName, title, labels, width, height, leftMargin) {
  ...
  plot <- barplot(dataToPlot, col="#69b3a2", cex.main=1.8, xlim=c(0, studies), cex=1.5, cex.names=1.5, las=1, horiz=TRUE)
...
plot(vars5$var5, "foundations", "Foundations", labels, 10, 10, 13)
...
plot(vars6$var6, "domains", "Domains", labels, 10, 10, 13)
...
plot(vars7$var7, "tools", "Tools", labels, 10, 10, 13)
...
plot(vars8$var8, "benefits", "Benefits", labels, 10, 10, 13)
